...
import com.maipatgeorge.tequila.ictwordguessinggames.Glev.GDB1;
...
// in database category, it take in guest user part.
...
public class GuestDB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sql = "SELECT * FROM "+TABLE_GuestPass+" WHERE "+KEY_L_ID+" = ( SELECT "+KEY_ID+" FROM "+TABLE_Level+" WHERE "+KEY_catID+" = 3) AND "+KEY_Gname+" = ?";
        ...
        correct1 = (ImageView) findViewById(R.id.gdblev12);
        correct2 = (ImageView) findViewById(R.id.gdblev22);
        correct3 = (ImageView) findViewById(R.id.gdblev32);
        correct4 = (ImageView) findViewById(R.id.gdblev42);
        correct5 = (ImageView) findViewById(R.id.gdblev52);
        correct6 = (ImageView) findViewById(R.id.gdblev62);
        correct7 = (ImageView) findViewById(R.id.gdblev72);
        correct8 = (ImageView) findViewById(R.id.gdblev82);
        correct9 = (ImageView) findViewById(R.id.gdblev92);
        ...
        lv1 = (Button) findViewById(R.id.gdblev11);
        lv1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent welcome = new Intent(GuestDB.this, GDB1.class);
