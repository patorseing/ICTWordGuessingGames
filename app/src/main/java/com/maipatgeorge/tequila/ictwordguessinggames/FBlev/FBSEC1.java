...
public class FBSEC1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sql = "SELECT  * FROM "+TABLE_FbuserPass+" WHERE "+KEY_F_ID+" = ? and " + KEY_L_ID +" = 2";
        ...
        share.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    File file = new File(FBSEC1.this.getExternalCacheDir(),"FBSEC1share.png");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == android.R.id.home){
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    Intent welcome = new Intent(FBSEC1.this, FBuserSEC.class);
    ...
    public void myDialogs(){
        dialog = new Dialog(FBSEC1.this);
        dialog.setContentView(R.layout.dialogscongres);

        linearLayout = new LinearLayout(FBSEC1.this);
        linearLayout = (LinearLayout) dialog.findViewById(R.id.l1);
        linearLayout.setEnabled(true);

        congrats = new GifImageView(FBSEC1.this);
